...
const Login = () => {
  ...
  // Check for error parameter in URL (from OAuth failure)
  useEffect(() => {
    const params = new URLSearchParams(location.search);
    const error = params.get('error');
    if (error) {
      if (error === 'google_auth_failed') {
        setErrorMsg('Google authentication failed. Please try again or use email/password.');
  ...
  const handleGoogleLogin = () => {
    // Use environment variable for Google auth URL
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                autoComplete="email"
                required
                className="appearance-none relative block w-full px-3 py-3 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-md shadow-sm focus:outline-none focus:ring-brand-blue focus:border-brand-blue focus:z-10 sm:text-sm"
